...
#include "pxr/asset.hpp"
#include "pxr/chassis/trackingWheel.hpp"
#include "pxr/pose.hpp"
#include "pxr/pid.hpp"
#include "pxr/exitcondition.hpp"
#include "pxr/driveCurve.hpp"
...
class OdomSensors {
    public:
         ...
         * pxr::TrackingWheel vertical1(&vertical_rotation, pxr::Omniwheel::NEW_275, 0.5);
         * pxr::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * pxr::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * pxr::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * pxr::Pose poseB(5.3, 12.2, 3.14);
