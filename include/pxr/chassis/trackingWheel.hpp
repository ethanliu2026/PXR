...
class TrackingWheel {
    public:
         ...
         * pxr::TrackingWheel verticalTrackingWheel(&verticalEncoder, pxr::Omniwheel::NEW_275, -5);
         ...
         * pxr::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, pxr::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * pxr::TrackingWheel leftTrackingWheel(&leftMotors, pxr::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by pxr, this will automatically be called when
         ...
         *     pxr::TrackingWheel exampleTrackingWheel(&exampleEncoder, pxr::Omniwheel::NEW_275, 0.5);
         ...
         *     pxr::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, pxr::Omniwheel::NEW_275, 0.5);
