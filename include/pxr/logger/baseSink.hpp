...
namespace pxr {
/**
 * @brief A base for any sink in pxr to implement.
 *
 * Sinks are pxr's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * pxr::BaseSink combinedSink({pxr::telemetrySink(), pxr::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(pxr::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[pxr] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
