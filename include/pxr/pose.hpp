...
class Pose {
    public:
         ...
         * @code {.cpp}
         * // create a pose
         * pxr::Pose poseA(5, // x position
         *                    10, // y position
         *                    1.57); // heading
         * // create a pose
         * pxr::Pose poseB(5.2, 22); // x and y position, heading defaults to 0
         * @endcode
         */
         ...
         * @code {.cpp}
         * // create a pose
         * pxr::Pose poseA(5, 10, 1.57);
         * // create a pose
         * pxr::Pose poseB(5.2, 22, 2.22);
         * // add the two poses
         * pxr::Pose poseC = poseA + poseB;
         ...
         * pxr::Pose result = poseA.lerp(poseB, 0.5);
         ...
         * pxr::Pose pose(1, 0);
         * // rotate pose by pi/2
         * pxr::Pose result = pose.rotate(M_PI_2);
         * // result.x = 0, result.y = 1
         * @endcode
         */
